...
export const canisterId = process.env.MOTOKO_TUTORIAL_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./motoko_tutorial_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the motoko_tutorial_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./motoko_tutorial_frontend.did.js")._SERVICE>}
 */
export const motoko_tutorial_frontend = createActor(canisterId);
