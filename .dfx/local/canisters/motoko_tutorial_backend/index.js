...
export const canisterId = process.env.MOTOKO_TUTORIAL_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./motoko_tutorial_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the motoko_tutorial_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./motoko_tutorial_backend.did.js")._SERVICE>}
 */
export const motoko_tutorial_backend = createActor(canisterId);
